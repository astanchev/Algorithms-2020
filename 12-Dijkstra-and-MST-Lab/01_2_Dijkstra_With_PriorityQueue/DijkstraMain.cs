namespace _01_2_Dijkstra_With_PriorityQueue
{
    ...
    class DijkstraMain
    {
        static void Main(string[] args)
        {
            ...
            // the keys of the first dictionary represent the nodes and the inner dictionary represents the edges – it’s keys being the child nodes and it’s values being the distances
